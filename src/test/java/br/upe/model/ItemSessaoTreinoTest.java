...
class ItemSessaoTreinoTest {
    ...
    void deveCriarItemSessaoTreinoComTodosAtributos() {
        ItemSessaoTreino item = new ItemSessaoTreino(7, 12, 45.5);
    ...
    void deveAlterarAtributosComSetters() {
        ItemSessaoTreino item = new ItemSessaoTreino(1, 10, 30.0);
    ...
    void deveRetornarToStringFormatado() {
        ItemSessaoTreino item = new ItemSessaoTreino(3, 8, 60.0);
